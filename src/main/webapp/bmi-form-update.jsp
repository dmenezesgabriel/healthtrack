              ...
              <div class="row justify-content-md-center">
                <div class="col-md-8 col-lg-8 mb-3">
                  ...
                  <form class="needs-validation" action="bmi" method="post" novalidate>
                    ...
                    <input type="hidden" value="${bmi.id}" name="id">

                    <div class="has-validation mb-3">
                      <label for="height">Altura</label>
                      <input class="form-control" type="number" name="height"
                        onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)"
                        step="0.01" id="height" placeholder="0.00"
                        value="${bmi.height.measureValue}" required />
                    ...
                    <div class="has-validation mb-3">
                      ...
                      <input class="form-control" type="number" name="weight"
                        onchange="(function(el){el.value=parseFloat(el.value).toFixed(2);})(this)"
                        step="0.01" id="weight" placeholder="0.00"
                        value="${bmi.weight.measureValue}" required />
                      <div class="invalid-feedback">Campo obrigatório</div>
                    </div>
                    <div class="has-validation mb-3">
